...
| Component | Details |
|-----------|---------|
| `reward_model.pt` | DistilBERT fine-tuned on Diplomacy data, val loss 0.102 |
...
| `selfplay_states.json` | 211,278 labeled Diplomacy game states |
| `phase1_final.pt` | TinyLlama 1.1B, GRPO Phase 1 trained, reward curve -0.35 → +0.63 over 200 steps |
...
│   ├── checkpoints/
│   │   ├── reward_model.pt      # ✅ BUILT — saved checkpoint
│   │   ├── phase1_final.pt      # ✅ BUILT — TinyLlama GRPO Phase 1 checkpoint
│   │   ├── phase2_final.pt      # 🔲 TODO — after Session B2
│   │   └── phase3_final.pt      # 🔲 POST-MVP — after Session B3
│   ├── data/
│   │   └── selfplay_states.json # ✅ BUILT — 211,278 labeled Diplomacy states
...
→ Checkpoint saved: training/checkpoints/phase1_final.pt
...
| Training Data | selfplay_states.json, 211,278 states | ✅ Built |
